...
def total_cash_needed_step(payload, cash_out):
    ...
    # counts as invested.
    refi_shortfall = max(Decimal("0"), -cash_out.cash_out_routi)
    total_cash_needed = cash_out.total_cash_invested + payload.rehab_cushion + refi_shortfall
    cash_needed_conservative = cash_out.total_cash_invested + payload.rehab_cushion + cash_out.cash_to_refi_table_conservative
