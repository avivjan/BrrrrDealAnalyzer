"""The explanation layer: turns a finished results_w_intermediates record into the `breakdowns` the PDF renders.

One module per deal type (`brrr.py`, `flip.py`). Each reads the frozen results_w_intermediates
