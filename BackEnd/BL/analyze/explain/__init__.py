"""The explanation layer: turns a finished calc record into the `breakdowns` the PDF renders.

One module per deal type (`brrr.py`, `flip.py`). Each reads the frozen calc
