...
INSTRUCTIONS = (
    ...
    "total_cash_needed_for_deal (Cash Needed) = total_cash_invested + rehab cushion + "
    "cash_to_refi_table_conservative: the single out-of-pocket figure through the refi, planned on the "
    "lowest-ARV stress test (there is no baseline or buffered variant). "
    ...
    "credits the buyer. equity = ARV minus the new loan plus the recoverable reserves. net_profit = equity "
