...
INSTRUCTIONS = (
    ...
    "total_cash_needed_for_deal (Cash Needed) = total_cash_invested + rehab cushion + refi shortfall: "
    "the single out-of-pocket figure through the refi (there is no separate buffered figure any more). "
